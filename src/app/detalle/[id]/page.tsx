    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm">
          <div><span className="text-muted-foreground">Categoria:</span> {item.category}</div>
          ...
          <div><span className="text-muted-foreground">Importe:</span> {item.amount.toFixed(2)} EUR</div>
